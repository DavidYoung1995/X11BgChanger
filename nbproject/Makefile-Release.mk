...
${OBJECTDIR}/ExtraUtility.o: ExtraUtility.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtraUtility.o ExtraUtility.cpp

${OBJECTDIR}/RootWindow.o: RootWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RootWindow.o RootWindow.cpp
...
${TESTDIR}/tests/ImlibBgTest.o: tests/ImlibBgTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ImlibBgTest.o tests/ImlibBgTest.cpp


${TESTDIR}/tests/extrautilityTest.o: tests/extrautilityTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/extrautilityTest.o tests/extrautilityTest.cpp
...
${OBJECTDIR}/ExtraUtility_nomain.o: ${OBJECTDIR}/ExtraUtility.o ExtraUtility.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtraUtility_nomain.o ExtraUtility.cpp;\
	else  \
...
${OBJECTDIR}/RootWindow_nomain.o: ${OBJECTDIR}/RootWindow.o RootWindow.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RootWindow_nomain.o RootWindow.cpp;\
	else  \
